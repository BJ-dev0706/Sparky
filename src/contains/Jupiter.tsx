...
const JupiterTerminal = (props: {
  ...
  return (
    <div className="h-[600px] w-full rounded-2xl text-white flex flex-col items-center p-2 lg:p-4 mb-4 overflow-clip mt-9 z-30">
      {!isLoaded ? (
            <div className="flex h-full lg:w-[30%] md:w-[40%] w-full overflow-auto justify-center px-[5vw] py-[3vh] border-4 bg-[#1c2936] rounded-xl ">
          ...
          <div
            ...
            className={`flex h-full lg:w-[30%] md:w-[40%] w-full overflow-auto justify-center px-5 py-10 border-4 bg-[#1c2936] rounded-xl ${
              !isLoaded ? 'hidden' : ''
            }`}
          />
    </div>
